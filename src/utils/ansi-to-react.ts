...
import { createElement, CSSProperties, JSX, ReactNode } from "react";
...
function convertBundleIntoReact(
  ...
  if (!linkify) {
    return createElement("span", { style, key, className }, bundle.content);
  }
  ...
  return createElement("span", { style, key, className }, content);
}
